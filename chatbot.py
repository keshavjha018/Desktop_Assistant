...
chat = ['good morning Walter','morning Walter']
chat_replay = ['good morning sir i hope your day will be good','good morning sir how amy i help you']
chat_2 = ['thankyou Walter','thankyou']
chat_2_replay =['your welcome','my pleasure','enjoy your day, sir']
chat_3 = ['you are idiot','what had you done']
chat_3_replay = ['sorry sir,i apologize','sorry sir']
chat_4 = ['nice work','nice work Walter','good work','its awesome']
chat_4_replay = ['Thank you, sir', 'nice to hear from you, sir', 'my pleasure']